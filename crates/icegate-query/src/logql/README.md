...
3.  **Binary Operations:** Implement vector matching logic for binary operations to support complex alerting rules.
4.  **Instant Query:** Implement `/loki/api/v1/query` endpoint for single-point-in-time metric queries.
