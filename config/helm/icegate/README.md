...
| ingest.waitForDependencies.awsCliImage | string | `"amazon/aws-cli:2.35.15"` |  |
...
| ingest.waitForDependencies.image | string | `"busybox:1.37"` |  |
...
| maintain.waitForDependencies.awsCliImage | string | `"amazon/aws-cli:2.35.15"` |  |
...
| maintain.waitForDependencies.image | string | `"busybox:1.37"` |  |
...
| migrate.waitForDependencies.awsCliImage | string | `"amazon/aws-cli:2.35.15"` |  |
...
| migrate.waitForDependencies.image | string | `"busybox:1.37"` |  |
...
| query.waitForDependencies.awsCliImage | string | `"amazon/aws-cli:2.35.15"` |  |
...
| query.waitForDependencies.image | string | `"busybox:1.37"` |  |
