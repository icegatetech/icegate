...
| ingest.otlpGrpc.host | string | `"0.0.0.0"` |  |
| ingest.otlpGrpc.port | int | `4317` |  |
| ingest.otlpHttp.enabled | bool | `true` |  |
| ingest.otlpHttp.host | string | `"0.0.0.0"` |  |
...
| ingest.service.otlpGrpcPort | string | `nil` |  |
| ingest.service.otlpHttpPort | string | `nil` |  |
