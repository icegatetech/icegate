...
| ingest.authProxy.enabled | bool | `false` |  |
| ingest.authProxy.image.pullPolicy | string | `"IfNotPresent"` |  |
| ingest.authProxy.image.repository | string | `"envoyproxy/envoy"` |  |
| ingest.authProxy.image.tag | string | `"v1.36.10"` |  |
| ingest.authProxy.jwt.audience | string | `""` |  |
| ingest.authProxy.jwt.clockSkewSeconds | int | `60` |  |
| ingest.authProxy.jwt.headerType | string | `"at+jwt"` |  |
| ingest.authProxy.jwt.issuer | string | `""` |  |
| ingest.authProxy.jwt.jwksCacheDurationSecs | int | `300` |  |
| ingest.authProxy.jwt.jwksUri | string | `""` |  |
| ingest.authProxy.jwt.tokenType | string | `"ingest"` |  |
| ingest.authProxy.jwt.trustedCaFile | string | `"/etc/ssl/certs/ca-certificates.crt"` |  |
| ingest.authProxy.resources | object | `{}` |  |
| ingest.authProxy.tls.secretName | string | `""` |  |
| ingest.authProxy.upstream.otlpGrpcPort | int | `14317` |  |
| ingest.authProxy.upstream.otlpHttpPort | int | `14318` |  |
| ingest.authProxy.upstreamTimeout | string | `"30s"` |  |
...
| ingest.livenessProbe.httpGet.path | string | `"/health"` |  |
| ingest.livenessProbe.httpGet.port | string | `"metrics"` |  |
...
| ingest.metrics.host | string | `"0.0.0.0"` |  |
...
| ingest.readinessProbe.httpGet.path | string | `"/health"` |  |
| ingest.readinessProbe.httpGet.port | string | `"metrics"` |  |
...
| ingest.tenant.id | string | `"default"` |  |
| ingest.tenant.mode | string | `"single"` |  |
